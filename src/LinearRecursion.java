/**
 * Recitation created by Toby Patterson, 5/22/2020 For CS165 at CSU With the
 * help of https://www.cs.colostate.edu/~cs165/.Spring20/recitations/L6/doc/
 *
...
public class LinearRecursion {
	...
	/**
	 * params: integer n return: n! or n * (n - 1) * (n - 2) * ... * 1 
	 */
	...
	/**
	 * params: integer n return: n + (n - 1) + (n - 2) + ... + 1 
	 */
	 ...
	 * params: n a positive number. return: the sum 1 + 1/2 + 1/3 + ... + 1/(n-1) + 1/n
	 */
	...
	/**
	 * Recursively return the sum of the geometric series. params: n a non-negative number. 
